...
public class KBottomSheetDialog {
    ...
    public KBottomSheetDialog(final Builder builder) {
        ...
        } else if (builder.animType == KAnimation.Animation_SHAKE) {
            dialog.getWindow().getAttributes().windowAnimations = R.style.AnimShake;
        }

        /* Negative == Cancel > Dismiss / Positive == Delete > Action*/

        // Instance Lottie Animation
        LottieAnimationView lottieAnimationView = dialog.findViewById(R.id.imageAnimation);
        // Instance Title TextView
        TextView setTitle = dialog.findViewById(R.id.textTitle);
        // Instance Message TextView
        TextView setMessage = dialog.findViewById(R.id.textMessage);
        // Instance Negative Button TextView
        TextView setNegativeBtnText = dialog.findViewById(R.id.btnTextNegative);
        // Instance Positive Button TextView
        TextView setPositiveBtnText = dialog.findViewById(R.id.btnTextPositive);
        // Instance Positive Button
        LinearLayout btnPositive = (LinearLayout) dialog.findViewById(R.id.btnDelete);
        // Instance Negative Button
        LinearLayout btnNegative = (LinearLayout) dialog.findViewById(R.id.btnCancel);
    ...
    public static class Builder {
        ...
        public com.mrkazofficial.kdialogs.KBottomSheetDialog show() {
            return new com.mrkazofficial.kdialogs.KBottomSheetDialog(this);
        }
